...
<!----------video---------->
               ...
               <label for="videolink">Upload a YouTube video:</label>
                ...
                <input class="shadow-sm p-3 mb-3 bg-white rounded form-update col-12" name="videolink" value="<?php if ($blog->video != "") {
...
<!--------genre--------------------------->
                        <div class="col">
                            ...
                            <input type='radio' id='genretag' name='genretag' value ='Food'<?php if ($blog->genre === 'Food') {
    echo "checked";
} ?>>
                            <label for="food">Food</label></br>
                            <input type='radio' id ='genretag' name='genretag' value='Family' <?php if ($blog->genre === 'Family') {
    echo "checked";
} ?>>
                            <label for="family">Family</label></br>
                            <input type='radio' id ='genretag' name='genretag' value='Craft'<?php if ($blog->genre === 'Craft') {
    echo "checked";
} ?>>
                            <label for='craft'>Craft</label></br>
                            <input type='radio' id ='genretag' name='genretag' value='Fitness'<?php if ($blog->genre === 'Fitness') {
    echo "checked";
} ?> >
...
<div class="form-group">
                ...
                <input type='radio' id='status' name='blogstatus' value ='Draft'<?php if ($blog->status === 'Draft') {
    echo "checked";
} ?>>
                <label for="draft">Save as draft</label></br>
                <input type='radio' id='status' name='blogstatus' value='Published'<?php if ($blog->status === 'Published') {
    echo "checked";
} ?>>
