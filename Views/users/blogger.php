                ...
                <div class="table-container-intro-account" role="table" aria-label="">
                    <div class="flex-table-account row" role="rowgroup">  
                        ...
                        <h1>Hello, <?php $blogger=userController::blogger();echo $blogger['user_FN'];?> !</h1>  
                        </div> 
                        
                        <div class="flex-row-intro-account" role="cell"> 
                        <img src="Views/<?php $blogger=userController::blogger();echo $blogger['user_IMG'];?>" class="account-img"   alt="...">
